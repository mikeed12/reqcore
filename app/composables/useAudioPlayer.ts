...
const SOUNDS = new Map([
    ["ringback", { audio: typeof Audio !== "undefined" ? new Audio(FILES["ringback"]) : '', volume: 1.0 }],
    ["ringing", { audio: typeof Audio !== "undefined" ? new Audio(FILES["ringing"]): '', volume: 1.0 }],
    ["answered", { audio: typeof Audio !== "undefined" ?  new Audio(FILES["answered"]): '', volume: 1.0 }],
    ["rejected", { audio: typeof Audio !== "undefined" ?  new Audio(FILES["rejected"]): '', volume: 0.5 }]
]);
